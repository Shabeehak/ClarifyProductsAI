...
def test_rag_query():
    ...
    print_section("Test 1: RAG Query - iPhone Camera")
...
def test_semantic_search():
    ...
    try:
        ...
        print(f"\nQuery: {payload['query']}")
        print(f"Found {len(results['results'])} relevant reviews")
...
def test_product_query():
    ...
    print_section("Test 3: Product-Specific Query - MacBook Pro")
...
def test_stats():
    """Test stats endpoint"""
    print_section("Test 4: Vector Database Stats")
